...
export class AboutComponent implements OnInit{
  paragraphs: string[] = [
    ...
    'Możecie być pewni, że moja praca opiera się na solidnej wiedzy z zakresu treningu funkcjonalnego. Potrafię łączyć różnorodne techniki i metody dostosowane do potrzeb konkretnej osoby. Nieustannie dbam o to, aby treningi były nie tylko skuteczne, ale także bezpieczne i motywujące, jednak nie łatwe, idąc na łatwiznę nie byłbym tu, gdzie teraz jestem. Moim celem jest nie tylko pomoc w transformacji fizycznej, ale także wsparcie w budowaniu zdrowych nawyków i pozytywnego podejścia do aktywności fizycznej, które przynosi długotrwałe korzyści dla zdrowia i samopoczucia. '
  ];
